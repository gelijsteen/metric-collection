...
class MavenProfileAppenderTest {
    ...
    void whenProfiles_expectValidProfilesElement(String fileName) {
        Path pomFile = Paths.get("src/test/resources/profiles/" + fileName);
        Path profileFile = Paths.get("src/test/resources/profiles/profile.xml");
    ...
    void whenUnknownProfilePresent_expectValidProfileAdded() {
        Path pomFile = Paths.get("src/test/resources/profiles/unknown_profile.xml");
        Path profileFile = Paths.get("src/test/resources/profiles/profile.xml");
    ...
    void whenMultipleProfilesPresent_expectValidProfileAdded() {
        Path pomFile = Paths.get("src/test/resources/profiles/pre_profile.xml");
        Path profileFile = Paths.get("src/test/resources/profiles/profile.xml");
