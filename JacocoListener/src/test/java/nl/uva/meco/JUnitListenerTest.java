...
public class JUnitListenerTest {
    ...
    public void whenTestSuccess_expectJacocoAgentUpdated() {
        ...
        inOrder.verify(agent).setSessionId("nl.uva.meco.JUnitListenerTest$TestSuccess#test");
        inOrder.verify(agent).dump(true);
    ...
    public void whenTestMultipleTests_expectJacocoAgentUpdated() {
        ...
        verify(agent).setSessionId("nl.uva.meco.JUnitListenerTest$TestMultipleTests#test1");
        verify(agent).setSessionId("nl.uva.meco.JUnitListenerTest$TestMultipleTests#test2");
    ...
    public void whenTestFailure_expectJacocoAgentUpdated() {
        ...
        inOrder.verify(agent).setSessionId("");
        inOrder.verify(agent).dump(true);
        inOrder.verify(agent).setSessionId("nl.uva.meco.JUnitListenerTest$TestFailure#test");
        inOrder.verify(agent).dump(true);
        inOrder.verifyNoMoreInteractions();
    }
    ...
    public void whenTestException_expectJacocoAgentUpdated() {
        ...
        inOrder.verify(agent).setSessionId("");
        inOrder.verify(agent).dump(true);
        inOrder.verify(agent).setSessionId("nl.uva.meco.JUnitListenerTest$TestException#test");
        inOrder.verify(agent).dump(true);
        inOrder.verifyNoMoreInteractions();
    }
